...
public class CreateQrCodeUseCaseImpl implements CreateQrCodeUseCase {
	...
	public CreateQrCodeUseCaseImpl(RestTemplate restTemplatePayments, RestTemplate restTemplateKeycloak,
			String paymentBaseUrl, String keycloakBaseUrl, String clientId, String clientSecret) {
	...
	public BufferedImage execute(Order order) throws IOException {
		...
		ResponseEntity<byte[]> response = restTemplatePayments.exchange(paymentBaseUrl + paymentPath, HttpMethod.POST,
