...
class PaymentDTOTest {
	...
	void testPaymentDTO() {
		...
		OrderResponsePaymentDTO orderResponsePaymentDTO = new OrderResponsePaymentDTO(1L, null, LocalDateTime.now(),
				LocalDateTime.now().plusHours(1), null, null, null, BigDecimal.valueOf(100.50));
