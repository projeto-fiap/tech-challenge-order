...
class IngredientItemTest {
	...
	void testIngredientItemCreation() {
		...
		IngredientItem ingredientItem = new IngredientItem("Tomato", "Fresh tomato slices",
				"http://example.com/tomato.jpg", new BigDecimal("1.50"), currency, IngredientCategory.ADDITIONAL, 5L);
