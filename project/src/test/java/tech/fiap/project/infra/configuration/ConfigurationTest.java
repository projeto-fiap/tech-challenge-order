...
class ConfigurationTest {
    ...
    void testDeliverOrderUseCaseBean() {
        ...
        // Act
        DeliverOrderUseCase deliverOrderUseCase = configuration.deliverOrderUseCase(createOrUpdateOrderUseCase, retrieveOrderUseCase);
    ...
    void testEndOrderUseCaseBean() {
        ...
        // Act
        EndOrderUseCase endOrderUseCase = configuration.endOrderUseCase(createOrUpdateOrderUseCase, retrieveOrderUseCase, createQrCodeUseCase);
