...
public class OrderMapper {
	...
	// }
	//
	// public static List<OrderResponseDTO> toDTO(List<Order> orders, List<Kitchen>
	// kitchens) {
	// return orders.stream().map(order -> {
	// Optional<Kitchen> kitchen = kitchens.stream()
	// .filter(kitchen1 -> Objects.equals(kitchen1.getOrderId(),
	// order.getId())).findFirst();
	...
	// kitchen.ifPresent(value ->
	// orderResponseDTO.setKitchenQueue(KitchenMapper.toDTO(value)));
